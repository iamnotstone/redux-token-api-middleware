...
function checkTokenFreshness(token, minTokenLifespan) {
  var tokenPayload = (0, _jwtDecode2.default)(token);
  var expS = tokenPayload.exp;
  var curS = new Date().getTime() * 0.001;
...
var TokenApiService = exports.TokenApiService = function () {
  ...
  _createClass(TokenApiService, [{
    ...
    value: function getApiFetchArgsFromActionPayload(payload) {
      ...
      return [endpoint, (0, _lodash12.default)({ method: method, body: body, credentials: credentials, headers: headers, mode: mode }, _lodash6.default)];
    }
  }, {
    key: 'call',
    value: function call() {
